#!/usr/bin/env python3
"""Generate clean config.py - Part 1: Constants"""
import os
...
with open("ml/config.py", "w") as f:
    f.write(header)
"""Generate clean config.py - Part 2: Functions and more"""
...
with open("ml/config.py", "a") as f:
    f.write(classes_and_funcs)
print("Part 2 written")

# Part 3: KPI mapping, model, training, gemini
part3 = '''
...
# Part 4: Model, training, gemini config, __all__
part4 = '''
...
with open("ml/config.py", "a") as f:
    f.write(part4)
print("Part 4 written - config.py complete!")
